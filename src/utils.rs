...
mod tests {
    use super::{
        address_to_pubkeyhash, calculate_merkle_root, coinbase_merkle_links, double_hash_256,
        scrypt_hasher,
    };
    ...
    fn test_calculate_merkle_root_2() {
        ...
        let expected_merkle_root =
            "60e96914503b6fba05feb27c343263471e8da0d855665f80c0f65a5cc0c6e6fd";
    ...
    fn test_calculate_merkle_root_3() {
        ...
        let expected_merkle_root =
            "5766798857e436d6243b46b5c1e0af5b6806aa9c2320b3ffd4ecff7b31fd4647";
    ...
    fn test_scrypt_hasher_2() {
        ...
        assert_eq!(
            hex::encode(scrypt_hash),
            "00000b4bdd2b7681ea81fe1f060f1306a516f726f01ddbc07d81171e8c697f2c"
        );
    }
    ...
    fn test_scrypt_hasher_3() {
        ...
        assert_eq!(
            hex::encode(scrypt_hash),
            "00000a5c0c8833a6feb840ea807d98f0b479a4813687fd9189c728819e1a5821"
        );
    }
    ...
    fn test_scrypt_hasher_4() {
        ...
        assert_eq!(
            hex::encode(scrypt_hash),
            "0000050e6c273d00bb83f38b3f22a9a6b2a22246949cf8fc0f756e13716bf5c3"
        );
    }
    ...
    fn test_calculate_merkle_root_4() {
        ...
        let expected_merkle_root =
            "f4291128de79e485d7a470f219183cb330d2c8177823db26f6065e1a4817a87e";
    ...
    fn test_calculate_txid() {
        ...
        assert_eq!(
            hex::encode(txid),
            "39114237793101c42ead607f9f7e0edbf400f8d2e659ec3aca6fe35388017483"
        );
    }
